            ...
            <div class="detail-summary">
              ...
              <div class="detail-summary__group">
                ...
                <div class="detail-actions">
                  ...
                  <button type="button" class="primary-btn detail-buy-now" @click="handleAddToCart(true)">
                    Mua ngay
                  </button>
                </div>
              </div>
...
const hasSale = computed(() => hasVariantSale.value)
...
async function handleAddToCart(redirectToCheckout = false) {
  ...
  try {
    ...
    message.value = redirectToCheckout ? 'Đã thêm sản phẩm. Đang chuyển sang trang thanh toán...' : 'Đã thêm sản phẩm vào giỏ hàng.'
